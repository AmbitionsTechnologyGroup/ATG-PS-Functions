...
$GoodApps =	"Dell|WavesAudio|store|calculator|sticky|store|windows.photos|soundrecorder|mspaint|screensketch|Microsoft.HEIFImageExtension|Microsoft.HEVCVideoExtension|Microsoft.VP9VideoExtensions|Microsoft.WebMediaExtensions|Microsoft.WebpImageExtension|Extension|Microsoft.YourPhone|Alarms"
